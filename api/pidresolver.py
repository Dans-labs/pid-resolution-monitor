...
def get_resolved_pid_status_code(pid: str) -> Optional[ResolutionRecord]:
    ...
    if pidx.lower().startswith("http:") and pid.lower().startswith("https:"):
        # idutils returns http:// instead of https://doi.org and will therefore invoke one more additional redirect than the original pid would have done. So we correct this here.
...
def resolve_pid(pid: str, verify: bool) -> tuple[Optional[httpx.Response], bool, Optional[str]]:
    ...
    client = httpx.Client(follow_redirects=True, timeout=httpx.Timeout(settings.PIDRESOLVER_TIMEOUT), verify=verify, max_redirects=settings.PIDRESOLVER_MAX_REDIR, headers={"user-agent": settings.PIDRESOLVER_USER_AGENT})
    try:
...
if __name__ == "__main__":
    ...
    pids = ["http://hdl.handle.net/10261/231953", "http://dx.doi.org/10.20350/digitalCSIC/8615", "http://hdl.handle.net/10261/231860", "http://hdl.handle.net/10261/231993", "http://hdl.handle.net/10261/235890",
            "http://dx.doi.org/10.20350/digitalCSIC/8960", "http://hdl.handle.net/10261/235967", "http://hdl.handle.net/10261/231753", "http://hdl.handle.net/10261/235934", "http://hdl.handle.net/10261/216881",
            "http://dx.doi.org/10.20350/digitalCSIC/13835", "http://hdl.handle.net/10261/236026", "http://dx.doi.org/10.20350/digitalCSIC/13782", "http://hdl.handle.net/10261/231894", "http://dx.doi.org/10.20350/digitalCSIC/13680",
            "http://hdl.handle.net/10261/231953", "http://fshhstrjhfjhkk.org/10.20350/digitalCSIC/8615", "https://doi.org/10.25606/SURF.578c6039-0efb60b8", "https://doi.org/10.25606/SURF.578c6039-8f766ac7",
            "https://doi.org/10.25606/SURF.578c6039-0c8c9310", "https://doi.org/10.25606/SURF.578c6039-6dbee678", "https://doi.org/10.25606/SURF.578c6039-a71f8bdc", "https://doi.org/10.25606/SURF.578c6039-22c5c9fd",
            "https://doi.org/10.25606/SURF.636f736d6f67-44", "https://doi.org/10.25606/SURF.578c6039-25cfab2c", "https://zenodo.org/doi/10.5281/zenodo.4672413", "https://doi.org/10.25606/SURF.578c6039-f84d9032"]
    for pid in pids:
        print(pid)
        print(get_resolved_pid_status_code(pid))
